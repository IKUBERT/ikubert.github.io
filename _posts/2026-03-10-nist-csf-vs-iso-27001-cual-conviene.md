...
categoria: iku-risk
lectura: 7
resumen: "NIST CSF es un marco flexible para ordenar y medir la ciberseguridad; ISO 27001 es una norma certificable. Diferencias, cuándo conviene cada uno y cómo se relacionan con la Ley Marco de Ciberseguridad en Chile."
description: "Comparación práctica entre NIST Cybersecurity Framework 2.0 e ISO/IEC 27001:2022: qué son, diferencias, costos, certificación y cuál conviene según tamaño, sector y la Ley 21.663 en Chile."
linkedin: ""
wa_msg: "Hola IKUBERT, leí el artículo NIST vs ISO 27001 y quiero saber qué marco le conviene a mi empresa."
keywords: [NIST CSF, ISO 27001, marco de ciberseguridad, SGSI, Ley 21.663, ciberseguridad Chile, IKU-Risk, IKUBERT]
---
...
En Chile, la [Ley N° 21.663, Marco de Ciberseguridad](https://www.bcn.cl/leychile/navegar?idLey=21663), creó la Agencia Nacional de Ciberseguridad (ANCI) y establece obligaciones para quienes prestan servicios esenciales y, con mayor exigencia, para los **operadores de importancia vital**. Entre ellas: implementar un sistema de gestión de seguridad de la información y reportar incidentes. Para esas organizaciones, un SGSI alineado con ISO 27001 es una base natural. A esto se suma la [Ley N° 21.719](https://www.bcn.cl/leychile/navegar?idLey=21719) de protección de datos personales, que exige medidas de seguridad proporcionales al riesgo.
...
En el framework [IKU-Risk™](/servicios/diagnostico-digital) evaluamos la postura de la empresa contra **NIST CSF**, **ISO 27001** y **CIS Controls v8**. Así el informe sirve tanto para decidir qué corregir primero como para preparar una eventual certificación.

¿No tienes claro qué marco necesita tu empresa? [Conversemos](/#contacto): en una sesión de 30 minutos te decimos por dónde partir.
