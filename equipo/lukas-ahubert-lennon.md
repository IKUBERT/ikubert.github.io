...
Su trabajo aplica la **investigación operativa y la modelación cuantitativa a la mitigación de riesgos críticos junto a la ciberseguridad ofensiva y la gestión de vulnerabilidades basada en riesgo (RBVM)**: desde la optimización de procesos y control de pérdidas en la cadena de suministro, hasta la evaluación técnica de infraestructura digital. Su enfoque traduce la complejidad técnica y matemática en decisiones ejecutivas orientadas a proteger el margen y asegurar la continuidad operativa del negocio.
